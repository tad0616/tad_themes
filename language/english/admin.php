...
define('_MA_TADTHEMES_BG_REPEAT', 'Background-repeat');
define('_MA_TADTHEMES_BG_REPEAT_NORMAL', 'Repeat');
define('_MA_TADTHEMES_BG_REPEAT_X', 'Repeat_x');
define('_MA_TADTHEMES_BG_REPEAT_Y', 'Repeat_y');
define('_MA_TADTHEMES_BG_NO_REPEAT', 'No_repeat');
...
define('_MA_TADTHEMES_BG_POSITION', 'Background-position');
...
define('_MA_TAD_THEMES_NOT_TAD_THEME', 'Default Theme "%s" that is compatible with Tad Themes .<div > "%s" not found.</div>');
...
define('_MA_TADTHEMES_SLIDE_DEFAULT_DESCRIPT', 'You can upload slider images from tad_theme admin. You can edit description for images with HTML tag.');

define('_MA_TADTHEMES_TARGET_FANCYBOX', 'ColorBox');
define('_MA_TADTHEMES_OF_LEVEL', 'Parent');
define('_MA_TADTHEMES_ICON', 'Font Awesome icon');
