...
define('_MA_TADTHEMES_LOGO_IMG', 'logo區');
...
define('_MA_TADTHEMES_NAVBAR', '導覽列');
define('_MA_TADTHEMES_NAVBAR_POSITION', '導覽列位置');
...
define('_MA_TADTHEMES_EDIT_MENU_TAD_BOOKING', '預約場地設備');
