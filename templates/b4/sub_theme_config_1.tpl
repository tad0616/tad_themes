...
<div class="form-group row">
    ...
    <!--右區塊顏色-->
    <{if $enable.rb_color}>
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_RB_COLOR}></label>
        <div class="col-sm-2">
...
<div class="form-group row">
    <!--左區塊寬度-->
    <{if $enable.lb_width}>
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_LB_WIDTH}></label>
        <div class="col-sm-2">
            <div class="input-group">
    ...
    <!--中區塊寬度-->
    <{if $enable.cb_width}>
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_CB_WIDTH}></label>
        <div class="col-sm-2">
            <div class="input-group">
    ...
    <!--右區塊寬度-->
    <{if $enable.rb_width}>
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_RB_WIDTH}></label>
        <div class="col-sm-2">
            <div class="input-group">
...
<{if $config2_base}>
    <div class="alert alert-warning">
        <h4>
            <a href="main.php?op=export_config2&theme_id=<{$theme_id}>&type=config2_base" class="btn btn-info btn-sm pull-right"><{$smarty.const._MA_TADTHEMES_EXPORT2|sprintf:'config2_base'}></a>
