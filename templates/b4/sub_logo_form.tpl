...
<{if $fonts}>
    <form action="font2pic.php" id="myForm" method="post" role="form">
        ...
        <div class="form-group row">
            <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_LOGO_SHADOW_SIZE}></label>
            <div class="col-sm-4">
            ...
            <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_LOGO_SHADOW_COLOR}></label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_LOGO_SHADOW_X}></label>
            <div class="col-sm-4">
                <input type="number" name="shadow_x" class="col-sm-10 form-control" value="<{$shadow_x}>" id="shadow_x">
            </div>
            <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_LOGO_SHADOW_Y}></label>
            <div class="col-sm-4">
