...
<form action="font2pic.php" method="post" role="form" enctype="multipart/form-data">
    <div class="form-group row">
        <label for="title" class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MA_TADTHEMES_FONT_UPLOAD}></label>
        <div class="col-sm-10">
            <{$fontUpForm}>
        </div>
    </div>
