...
<{if $config2_logo}>
    <div class="alert alert-warning">
        <h4>
            <a href="main.php?op=export_config2&theme_id=<{$theme_id}>&type=config2_logo" class="btn btn-info btn-sm pull-right"><{$smarty.const._MA_TADTHEMES_EXPORT2|sprintf:'config2_logo'}></a>
