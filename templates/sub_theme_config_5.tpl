                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <{if $enable.bt_text=="1"}>
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="bt_text[<{$block.block_position}>]" id="bt_text_<{$block.block_position}>" value="<{$block.bt_text}>" class="form-control <{$validate.bt_text}>"  data-text="hidden" data-hex="true" style="height: 42px; width: 60%;">
                            </div>
                        <{else}>
                        ...
                        <{if $enable.bt_bg_color=="1"}>
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="bt_bg_color[<{$block.block_position}>]" id="bt_bg_color_<{$block.block_position}>" value="<{$block.bt_bg_color}>" class="form-control <{$validate.bt_bg_color}>" data-text="hidden" data-hex="true" style="height: 42px; width: 60%;">
                            </div>
                        <{else}>
