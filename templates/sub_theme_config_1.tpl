...
<div class="form-group">    
    ...
    <div class="col-sm-2">        
        ...
        <{else}>
            ...
            <{$theme_width}><{if $theme_kind=="mix"}>px<{else}><{$theme_unit}><{/if}>
        <{/if}>
    </div>
    ...
    <div class="col-sm-2">      
        <{if $enable.base_color}>
            <input type="text" name="base_color" class="form-control <{$validate.base_color}>" value="<{$base_color}>" id="base_color" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        <{else}>
...
<div class="form-group">
    ...
    <{if $enable.lb_color}>
        ...
        <div class="col-sm-2">
            <input type="text" name="lb_color" id="lb_color" value="<{$lb_color}>" class="form-control <{$validate.lb_color}>" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        </div>
    <{else}>
    ...
    <{if $enable.cb_color}>
        ...
        <div class="col-sm-2">
            <input type="text" name="cb_color" id="cb_color" value="<{$cb_color}>" class="form-control <{$validate.cb_color}>" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        </div>
    <{else}>
    ...
    <{if $enable.rb_color}>
        ...
        <div class="col-sm-2">
            <input type="text" name="rb_color" id="rb_color" value="<{$rb_color}>" class="form-control <{$validate.rb_color}>" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        </div>
    <{else}>
...
<div class="form-group">
    <!--左區塊寬度-->
    <{if $enable.lb_width}>
        <label class="col-sm-2 control-label"><{$smarty.const._MA_TADTHEMES_LB_WIDTH}></label>
        <div class="col-sm-2">
            <div class="input-group">
                <input type="text" name="lb_width" class="form-control <{$validate.lb_width}>" value="<{$lb_width}>" id="lb_width" onChange="change_css();">
                <span class="input-group-addon"><{$theme_unit}></span> 
            </div>       
        </div>
    <{else}>
    ...
    <!--右區塊寬度-->
    <{if $enable.rb_width}>
        <label class="col-sm-2 control-label"><{$smarty.const._MA_TADTHEMES_RB_WIDTH}></label>
        <div class="col-sm-2">
            <div class="input-group">
...
<div class="form-group">
    ...
    <{if $enable.font_color}>
        ...
        <div class="col-sm-2">
            <input type="text" name="font_color" id="font_color" value="<{$font_color}>" class="form-control <{$validate.font_color}>" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        </div>
    <{else}>
    ...
    <{if $enable.link_color}>
        ...
        <div class="col-sm-2">
            <input type="text" name="link_color" id="link_color" value="<{$link_color}>" class="form-control <{$validate.link_color}>" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        </div>
    <{else}>
    ...
    <{if $enable.hover_color}>
        ...
        <div class="col-sm-2">
            <input type="text" name="hover_color" id="hover_color" value="<{$hover_color}>" class="form-control <{$validate.hover_color}>" data-text="hidden" data-hex="true" style="height: 42px;" onChange="change_css();">
        </div>
    <{else}>
