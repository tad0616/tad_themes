...
// 儲存設定表單
function theme_config_form($theme_name = '', $theme_id = '')
{
...
{
    global $xoopsConfig;
    $theme_config_name = filter_var(substr($_FILES['config_zip']['name'], 0, -4), FILTER_SANITIZE_SPECIAL_CHARS);
...
switch ($op) {
    ...
    default:
        tad_themes_form();
        theme_config_form($theme_name, $theme_id);
        $op = 'tad_themes_form';
        break;
        /*---判斷動作請貼在上方--- */
}
