    ...
    public function addLineConfigLabel($text, $value = '', $type = 'default')
    {
        ...
        switch ($type) {
            ...
            case 'tadtools':
                ...
                if (mb_substr($tadtools_version, 0, 9) < $value) {
                    $line .= "<span style='color : red; font-weight : bold;'><img src='" . $path . "off.png' >" . sprintf($text, $value, mb_substr($tadtools_version, 0, 9)) . "</span>\n";
                } else {
                    $line .= "<span style='color : green;'><img src='" . $path . "on.png' >" . sprintf($text, $value, mb_substr($tadtools_version, 0, 9)) . "</span>\n";
                }
                break;
            case 'folder':
                if (!is_dir($value)) {
